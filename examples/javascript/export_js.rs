//! Export NL documents for JavaScript fixtures (express).
//!
//! Output:
...
async fn main() {
    ...
    let specs: Vec<(&str, FixtureSpec)> = vec![("express", FixtureSpec::javascript_express())];
    ...
    println!("\n=== All JavaScript fixtures exported ===");
}
