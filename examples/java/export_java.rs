//! Export NL documents for Java fixtures (basic, generics, control_flow, index_sidecar,
...
async fn main() {
    ...
    let specs: Vec<(&str, FixtureSpec)> = vec![
        ("basic", FixtureSpec::java_basic()),
        ("generics", FixtureSpec::java_type_inference_generics()),
        (
            "control_flow",
            FixtureSpec::java_type_inference_control_flow(),
        ),
        ("index_sidecar", FixtureSpec::java_index_sidecar()),
        ("springboot-minimal-demo", FixtureSpec::java_spring_boot()),
        ("jackson-core", FixtureSpec::java_jackson_core()),
    ];
